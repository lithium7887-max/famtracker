...
const App = () => {
  ...
  return (
    <div className="h-screen w-screen bg-bg-dark overflow-hidden relative">
      ...
      {/* Floating Bottom Card (Family List) */}
      <aside className="absolute bottom-6 left-4 right-4 max-h-[30dvh] bg-bg-dark/90 backdrop-blur-lg rounded-3xl border border-glass-border flex flex-col z-10 shadow-2xl overflow-hidden">
        <div className="flex-1 overflow-y-auto p-4 space-y-3">
          ...
          {members && members.map(member => {
            ...
            return (
              <div key={member.id} className="flex items-center gap-3 p-2.5 rounded-2xl bg-white/5 border border-white/5 hover:border-primary/30 transition-colors">
